...
author_subs_re = {
    ...
    r"Cyprien [dD]e Saint Guilhem": (r"Cyprien {Delpech de Saint Guilhem}", r"DelpechdeSaintGuilhem"),
    r"Cyprien Delpech [dD]e Saint Guilhem": (r"Cyprien {Delpech de Saint Guilhem}", r"DelpechdeSaintGuilhem"),
